...
Interactive demo for European option pricing using the Black-Scholes model.

## Learning Objectives

- Explain the main quant decision that Black Scholes Option is designed to support.
...
- Related demo: [Supply Chain Finance](../../SupplyChain/SupplyChainFinance/about.html)
