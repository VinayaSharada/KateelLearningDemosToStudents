# Feature Prioritization Copilot · PM Demo 02

## Overview

**Repository:** [KateelLearningDemosToStudents](https://github.com/VinayaSharada/KateelLearningDemosToStudents) **Author:** Professor Vinaya Sathyanarayana **Section:** `🤖 Browser-AI-Demos/PM-Product-Demos/2-feature-prioritization-copilot/`.

## Learning Objectives

- Explain the main ai/ml decision that Feature Prioritization Copilot · PM Demo 02 is designed to support.
