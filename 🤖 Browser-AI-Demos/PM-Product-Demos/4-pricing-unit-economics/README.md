# Pricing & Unit Economics Explorer — PM Demo 04

## Overview

**Repository:** [KateelLearningDemosToStudents](https://github.com/VinayaSharada/KateelLearningDemosToStudents) **Author:** Professor Vinaya Sathyanarayana **Section:** `🤖 Browser-AI-Demos/PM-Product-Demos/4-pricing-unit-economics/`.

## Learning Objectives

- Explain the main ai/ml decision that Pricing & Unit Economics Explorer — PM Demo 04 is designed to support.
