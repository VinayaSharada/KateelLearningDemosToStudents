...
Interactive AI Product Canvas for product planning and ideation.

## Learning Objectives

- Explain the main ai/ml decision that AI Product Canvas is designed to support.
...
Use this demo to make the central decision in AI Product Canvas explicit, surface the key trade-offs, and decide how you would adapt the workflow, assumptions, or outputs in your own context.
