...
- Explain the main cyber decision that Secure Code Review is designed to support.
...
- Course path: [Cybersecurity](../../courses/cybersecurity.html)
- Related demo: [Intrusion Detection](../../CyberSecurityDemos/IoTAircraftNetwork/IntrusionDetection/about.html)
- Related demo: [Network Traffic Analyzer](../../CyberSecurityDemos/IoTAircraftNetwork/NetworkTrafficAnalyzer/about.html)
- Related demo: [Pen Test Simulator](../../CyberSecurityDemos/IoTAircraftNetwork/PenTestSimulator/about.html)
...
Use this demo to make the central decision in Secure Code Review explicit, surface the key trade-offs, and decide how you would adapt the workflow, assumptions, or outputs in your own context.
