...
Interactive portfolio optimization demo using mean-variance optimization (Markowitz model).

## Learning Objectives

- Explain the main quant decision that Portfolio Optimizer is designed to support.
...
Use this demo to make the central decision in Portfolio Optimizer explicit, surface the key trade-offs, and decide how you would adapt the workflow, assumptions, or outputs in your own context.
