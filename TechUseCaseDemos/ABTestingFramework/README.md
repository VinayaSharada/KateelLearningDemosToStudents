...
Interactive demo for A/B testing with statistical significance.

## Learning Objectives

- Explain the main ai/ml decision that AB Testing Framework is designed to support.
...
Use this demo to make the central decision in AB Testing Framework explicit, surface the key trade-offs, and decide how you would adapt the workflow, assumptions, or outputs in your own context.
